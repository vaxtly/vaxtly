...
### Changed
- Improve app logging: unified all logs into a single `vaxtly.log` file, added boot timing across all Livewire component mounts and frontend JS markers

## [0.2.5] - 2026-02-11

### Fixed
- Environment modal not opening from collection/folder context menus after child component extraction
...
### Fixed
- Response panel clearing when switching tabs — last response now persists per tab until closed
