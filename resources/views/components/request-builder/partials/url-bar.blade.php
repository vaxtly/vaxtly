...
<div class="px-3 pt-3 pb-2 space-y-4 border-b border-gray-200 dark:border-gray-700 shrink-0">
    ...
    >
        ...
        <button
            ...
            class="h-10 w-20 inline-flex items-center justify-center gap-2
                   text-gray-600 dark:text-gray-200 bg-beartropy-300/70 dark:bg-beartropy-600/70 text-sm font-semibold rounded-r-lg transition-all
                   focus:outline-none cursor-pointer -mr-px -my-px -mb-px
                   disabled:opacity-75 disabled:cursor-wait whitespace-nowrap"
        >
            <div wire:loading.remove wire:target="sendRequest" class="flex items-center gap-2">
                <span>Send</span>
                <x-bt-icon name="rocket-launch" />
            </div>

            <div wire:loading wire:target="sendRequest" class="flex items-center gap-2">
